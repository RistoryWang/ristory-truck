...
func (this *BaseController) Prepare() {
	...
	this.Ctx.Output.Header("X-Author-By", "ristory")
...
func (this *BaseController) display(tpl ...string) {
	...
	this.Data["environment"] = beego.AppConfig.String("environment")
	...
	this.Data["emailMD5"] = md5sum1(user.Email)
