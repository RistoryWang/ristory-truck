...
func (this *EnvController) Add() {
	...
	if this.isPost() {
		...
		this.redirect(beego.URLFor("EnvController.List", "project_id", projectId,"typex", env.Type))
	}
...
func (this *EnvController) Edit() {
	...
	if this.isPost() {
		...
		this.redirect(beego.URLFor("EnvController.List", "project_id", env.ProjectId, "typex", env.Type))
	}
...
func (this *EnvController) Del() {
	...
	this.redirect(beego.URLFor("EnvController.List", "project_id", project_id, "typex", typex))
}
